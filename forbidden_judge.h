...
private:
    //Define a vector "forbidden_points" to store the forbidden points, which are from the previous chessboard and can help to check whether the recent moved black stone is put at the forbidden point.
